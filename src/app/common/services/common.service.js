...
exports.localUrl = 'http://0.0.0.0:8001/api/v1/';
exports.onlineUrl = 'http://35.187.38.114:8000/api/v1/';
exports.useLocal = true;
function delay(ms) {
    return new Promise(function (resolve) { return setTimeout(resolve, ms); });
}
exports.delay = delay;
var CommonService = (function () {
    function CommonService(_http, router) {
        this._http = _http;
        this.router = router;
        this._isLoggedIn = false;
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        this._APIurl = exports.useLocal ? exports.localUrl : exports.onlineUrl;
        this.commonUrl = 'common/';
        this.colorsUrl = this.commonUrl + 'colors/';
        this.fieldsUrl = this.commonUrl + 'subjects/';
    }
    Object.defineProperty(CommonService.prototype, "isLoggedIn", {
        get: function () {
    ...
    CommonService.prototype.getJwtToken = function () {
    ...
    CommonService.prototype.getColors = function () {
        return this.makeRequest(this.colorsUrl, 'GET');
    };
     ...
     */
    CommonService.prototype.makeRequest = function (endPoint, method, body, params, headers) {
        ...
        if (this.headers.get('Authorization') === null) {
            this.headers.append('Authorization', 'Bearer ' + this.getJwtToken());
        }
        if (method == 'GET') {
