...
export class CommonService {
  ...
  constructor(private _http: Http, protected router: Router) {}

  public headers = new Headers({'Content-Type': 'application/json'});
  protected _APIurl: string = useLocal? localUrl: onlineUrl;

  private commonUrl = 'common/';
  private colorsUrl = this.commonUrl + 'colors/';
  private fieldsUrl = this.commonUrl + 'subjects/';
  ...
  protected makeRequest (endPoint: string,
                       method: string, body: any = null, params: any = null,
