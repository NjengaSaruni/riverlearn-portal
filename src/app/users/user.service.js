...
var UserService = (function () {
    function UserService(http) {
        this.http = http;
        // private  usersUrl = 'http://0.0.0.0:8001/api/v1/users/';
        // private authUrl = 'http://0.0.0.0:8001/api/v1/api-token-auth/';
        this.usersUrl = 'http://35.187.27.188:8000/api/v1/users/';
        this.authUrl = 'http://35.187.27.188:8000/api/v1/api-token-auth/';
    }
